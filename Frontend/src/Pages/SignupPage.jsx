                    ...
                    <form onSubmit={submitHandler} className='space-y-6'>
                        <div className='form-control'>
                            ...
                            <div className='relative'>
                                ...
                                <input type="text" className='input input-bordered w-full pl-10 z-0' placeholder='Enter Full Name' value={formData.name} onChange={(e) => { setFormData({ ...formData, name: e.target.value }) }} />
                            </div>
                        </div>
